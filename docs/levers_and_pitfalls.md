...
The active target is the uniform ten-link plant. The nine-link parked-launch
route is the incumbent, and every result below starts from the hanging state or
from an exact saved state generated by that route. These are development
diagnostics only; none satisfies the canonical ten-link 20/100, video, and
fresh-clone release gates.
